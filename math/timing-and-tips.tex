...
\textbf{失分原因} & \textbf{典型场景} & \textbf{对策} \\ \hline
计算错误 & 移项忘变号、指数运算错 & 草稿工整、关键步骤复核 \\
审题偏差 & 漏看条件$x>0$ 或 $n\in\mathbb{N}^*$ 等 & 圈出关键词再下笔 \\
分类遗漏 & 二次项系数 $a=0$、斜率不存在 & 分类讨论前先想全所有可能 \\
公式记混 & 余弦定理写错符号 & 考前默写一遍公式 \\
规范失分 & 没有写"解"、没有标号 & 每题先写"解"再作答 \\
时间不足 & 在难题上纠结太久 & 3 分钟原则，果断跳过
\end{tabular}
\end{center}
